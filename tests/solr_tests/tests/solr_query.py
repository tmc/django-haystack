...
class SolrSearchQueryTestCase(TestCase):
    ...
    def test_build_query_boolean(self):
        self.sq.add_filter(QF(content=True))
        self.assertEqual(self.sq.build_query(), 'true')
    
    def test_build_query_datetime(self):
        self.sq.add_filter(QF(content=datetime.datetime(2009, 5, 8, 11, 28)))
    ...
    def test_build_query_multiple_filter_types(self):
        self.sq.add_filter(QF(content='why'))
        self.sq.add_filter(QF(pub_date__lte='2009-02-10 01:59:00'))
        self.sq.add_filter(QF(author__gt='daniel'))
        self.sq.add_filter(QF(created__lt='2009-02-12 12:13:00'))
    ...
    def test_build_query_in_filter_multiple_words(self):
        self.sq.add_filter(QF(content='why'))
        self.sq.add_filter(QF(title__in=["A Famous Paper", "An Infamous Article"]))
    ...
    def test_build_query_in_filter_datetime(self):
        self.sq.add_filter(QF(content='why'))
        self.sq.add_filter(QF(pub_date__in=[datetime.datetime(2009, 7, 6, 1, 56, 21)]))
